            ...
            success {
                ...
                script {
                    ...
                    if(!issueID.equals("")){
                        ...
                        jiraUtil.updateCommentwithBDD(filePath: "$JENKINS_HOME\\job\\${PIPELINE_ARRAY[0]}\\branches\\${env.BRANCH_NAME}\\cucumber-reports_fb242bb7-17b2-346f-b0a4-d7a3b25b65b4\\cucumber-trends.json", issue: issueID)
