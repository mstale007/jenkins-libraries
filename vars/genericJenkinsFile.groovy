...
def call(Map args =[buildMode: "mvn",jira_issue: ""]){
    ...
    pipeline{
            ...
            stage("Unit Tests"){
                ...
                post{
                    always {
                        ...
                        //     classPattern: '**/target/site/jacoco/classes',
        ...
        post{
            always{
                bat jira_updater.sendAttachment(issueID: args.jira_issue, attachmentLink: "${BUILD_URL}cucumber-html-reports_fb242bb7-17b2-346f-b0a4-d7a3b25b65b4/overview-features.html")
