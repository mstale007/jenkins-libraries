...
class JiraUpdater{
    ...
    //  \"https://mstale-test.atlassian.net/rest/api/latest/issue/\" + issueID +\"/attachments\""
        ...
        return "curl -s -i -X POST \"https://mstale-test.atlassian.net/rest/api/latest/issue/"+issue_ID+"/attachments\" --header \"Authorization:Basic c2hhbnRhbnVkMzkwQGdtYWlsLmNvbTo2YUpLV1VLTzN0bkR6SUZKNE5BRDdBNDE=\" --F \"file=@C:/creport33.html\""
    }
}